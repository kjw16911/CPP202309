...
bool checkWin() {
	...
	for (int i = 0; i < numCell; i++) {
		if (board[i][0] == currentUser && board[i][1] == currentUser && board[i][2] == currentUser && board[i][3] == currentUser && board[i][4] == currentUser&& board[i][5] == currentUser&& board[i][6] == currentUser&& board[i][7] == currentUser&& board[i][8] == currentUser&& board[i][9] == currentUser) {
	...
	for (int i = 0; i < numCell; i++) {
		...
		if (board[i][numCell - i + 1] == currentUser && board[i + 1][numCell - i + 2] == currentUser) {
